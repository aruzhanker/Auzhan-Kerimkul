...
street = pygame.image.load("WEEK8\\img\\Street.png")
screen.blit(street, (0, 0))

pygame.display.set_caption("Car Racing")
pygame.display.set_icon(pygame.image.load("WEEK8\\img\\Racing Icon.png"))

Oshiheteo = pygame.mixer.Channel(0).play(pygame.mixer.Sound("WEEK8\\sounds\\music.mp3"))
clock = pygame.time.Clock()
fps = 60
small = pygame.font.SysFont("", 30)
collection = "WEEK8\\sounds\\collection.mp3"

# Sprites

Player = "WEEK8\\img\\White lamba.png"
Opposite = "WEEK8\\img\\Yellow lamba.png"
coin = "WEEK8\\img\\Coinracer.png"
...
while exit:
    ...
    if (counter > 9):
        speed -= 0.005
        pygame.mixer.Channel(3).play(pygame.mixer.Sound("WEEK8\\sounds\\manycoins.mp3"))
        counter -= 10
