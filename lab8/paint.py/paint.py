...
pygame.display.set_icon(pygame.image.load("WEEK8\\img\\paint-icon.png"))
...
def control_panel():
    ...
    image_of_rectangle = pygame.image.load("WEEK8\\img\\rectangle.png")
    image_of_circle = pygame.image.load("WEEK8\\img\\circle.png")
    image_of_ellipse = pygame.image.load("WEEK8\\img\\ellipse.png")
    image_of_line = pygame.image.load("WEEK8\\img\\line.png")
    image_of_palette = pygame.image.load("WEEK8\\img\\palette.png")
