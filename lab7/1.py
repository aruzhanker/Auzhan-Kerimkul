...
mickey = pygame.image.load("WKND/images/main-clock.png")
minute_hand = pygame.image.load("WKND/images/righthand.png")
second_hand = pygame.image.load("WKND/images/lefthand.png")
